    ...
    public partial class Form1 : Form
    {
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.ControlKey)
            {
                ...
                startHotkey.Text = FormatPartialHotkey();
            ...
            if (e.KeyCode == Keys.Menu) // Alt key (why is alt called Menu?)
            {
            ...
            {
                startHotkey.Text = e.KeyCode.ToString();
        ...
        void FinalizeHotkey(Keys key)
        {
            ...
            uint vk = (uint)key;
            RegisterHotKey(this.Handle, 1, currentModifiers, vk);

            startHotkey.Text = FormatFinalHotkey(key);
